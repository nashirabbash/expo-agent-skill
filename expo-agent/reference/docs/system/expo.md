...
source_url: "https://docs.expo.dev/versions/latest/sdk/expo.md"
scraped_at: "2026-07-15T08:46:38.915495"
---
...
| Parameter | Type |
| --- | --- |
| `methods` | [PermissionHookMethods](#permissionhookmethods)<[Permission](#permission), Options\> |
...
Unlike [`Updates.reloadAsync()`](/versions/latest/sdk/updates.md#updatesreloadasync), this function does not use a new update even if one is available. It only reloads the app using the same JavaScript bundle that is currently running.
