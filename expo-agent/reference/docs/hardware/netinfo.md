...
source_url: "https://docs.expo.dev/versions/latest/sdk/netinfo.md"
scraped_at: "2026-07-15T08:44:26.313091"
---
...
-   Rebuild your app with [`eas build --platform ios`](/build/setup.md#4-run-a-build) or [`npx expo run:ios`](/more/expo-cli.md#compiling).
