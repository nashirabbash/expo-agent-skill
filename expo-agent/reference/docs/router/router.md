...
source_url: "https://docs.expo.dev/versions/latest/sdk/router.md"
scraped_at: "2026-07-15T08:45:29.670628"
---
...
| Parameter | Type | Description |
| --- | --- | --- |
| `NavigatorContent` | ComponentType<[NavigatorContentProps](#navigatorcontentprops)<[NavigatorOptions](#navigatoroptions), [EventMap](#eventmap), NavigatorProps\>\> | Renders the navigator UI; receives the standard-navigation `state`, `descriptors`, `actions`, and `emitter`. |
...
| navigate | (href: [Href](/versions/v57.0.0/sdk/router.md#hreft), options: [NavigationOptions](https://reactnavigation.org/docs/screen-options/)) => void | Navigates to the provided [`href`](#href). |
| prefetch | (name: [Href](/versions/v57.0.0/sdk/router.md#hreft)) => void | Prefetch a screen in the background before navigating to it |
| push | (href: [Href](/versions/v57.0.0/sdk/router.md#hreft), options: [NavigationOptions](https://reactnavigation.org/docs/screen-options/)) => void | Navigates to the provided [`href`](#href) using a push operation if possible. |
