...
source_url: "https://docs.expo.dev/versions/latest/sdk/calendar.md"
scraped_at: "2026-07-15T08:44:23.178028"
---
...
> To provide quicker updates, `expo-calendar` is currently unsupported in Expo Go and Snack. To use it, create a [development build](/develop/development-builds/create-a-build.md).
...
To only add events without reading existing calendar data, enable the `writeOnlyAccess` option in the [config plugin](/versions/latest/sdk/calendar.md#configuration-in-app-config) and request write-only access by passing `true` to [`requestCalendarPermissions`](/versions/latest/sdk/calendar.md#requestcalendarpermissions). This is sufficient for methods like [`ExpoCalendar.createEvent`](/versions/latest/sdk/calendar.md#createeventdetails). Methods that read calendar data, such as [`getCalendars`](/versions/latest/sdk/calendar.md#getcalendars), [`listEvents`](/versions/latest/sdk/calendar.md#listevents), or [`presentPicker`](/versions/latest/sdk/calendar.md#presentpicker), require full calendar access.
