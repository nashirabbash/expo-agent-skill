...
source_url: "https://docs.expo.dev/versions/latest/sdk/location.md"
scraped_at: "2026-07-15T08:43:37.938347"
---
...
| Parameter | Type | Description |
| --- | --- | --- |
| `callback` | [MotionActivityCallback](#motionactivitycallback) | This function is called on each motion activity update. It receives an object of type [`MotionActivityObject`](#motionactivityobject) as the first argument. |
...
To learn more on how to exclude permission, see [Excluding Android permissions](/guides/permissions.md#excluding-android-permissions).
