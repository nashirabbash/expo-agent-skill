...
source_url: "https://docs.expo.dev/versions/latest/sdk/background-fetch.md"
scraped_at: "2026-07-15T08:43:30.582108"
---
...
| --- | --- | --- |
| `taskName` | `string` | Name of the task to register. The task needs to be defined first - see [`TaskManager.defineTask`](/versions/latest/sdk/task-manager.md#taskmanagerdefinetaskttaskname-taskexecutor) for more details. |
