...
source_url: "https://docs.expo.dev/versions/latest/sdk/task-manager.md"
scraped_at: "2026-07-15T08:46:29.947211"
---
...
Unregisters task from the app, so the app will not be receiving updates for that task anymore. _It is recommended to use methods specialized by modules that registered the task, eg. [`Location.stopLocationUpdatesAsync`](/versions/latest/sdk/location.md#expolocationstoplocationupdatesasynctaskname)._
