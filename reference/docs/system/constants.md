...
source_url: "https://docs.expo.dev/versions/latest/sdk/constants.md"
scraped_at: "2026-07-15T08:46:22.873830"
---
...
Type: [ClientScopingConfigForReExport](/versions/latest/sdk/manifests.md#clientscopingconfigforreexport)

### `EASConfig`

Supported platforms: Android, iOS, tvOS, Web.

Type: [ManifestsEASConfig](/versions/latest/sdk/manifests.md#manifestseasconfig)

### `ExpoGoConfig`

Supported platforms: Android, iOS, tvOS, Web.

Type: [ManifestsExpoGoConfig](/versions/latest/sdk/manifests.md#manifestsexpogoconfig)

### `ExpoGoPackagerOpts`

Supported platforms: Android, iOS, tvOS, Web.

Type: [ExpoGoPackagerOptsForReExport](/versions/latest/sdk/manifests.md#expogopackageroptsforreexport)
...
Type: [ManifestAssetForReExport](/versions/latest/sdk/manifests.md#manifestassetforreexport)

### `ManifestExtra`

Supported platforms: Android, iOS, tvOS, Web.

Type: [ManifestExtraForReExport](/versions/latest/sdk/manifests.md#manifestextraforreexport)
...
| easConfig | [ManifestsEASConfig](/versions/latest/sdk/manifests.md#manifestseasconfig) | null | The standard EAS config object populated when using EAS. |
...
| expoGoConfig | [ManifestsExpoGoConfig](/versions/latest/sdk/manifests.md#manifestsexpogoconfig) | null | The standard Expo Go config object populated when running in Expo Go. |
