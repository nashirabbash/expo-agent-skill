...
source_url: "https://docs.expo.dev/versions/latest/sdk/router/native-tabs.md"
scraped_at: "2026-07-15T08:45:47.236543"
---
...
> See the [Expo Router](/versions/latest/sdk/router/index.md) reference for more information about the file-based routing library for native and web app.
...
Optional • Type: [Partial](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)<[Omit](https://www.typescriptlang.org/docs/handbook/utility-types.html#omittype-keys)<[TabsHostProps](#tabshostprops), 'children' | 'navStateRequest' | 'onTabSelected'\>\>
