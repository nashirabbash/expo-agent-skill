...
source_url: "https://docs.expo.dev/versions/latest/sdk/stripe.md"
scraped_at: "2026-07-15T08:44:51.332576"
---
...
Google Pay **is not** supported in [Expo Go](https://expo.dev/go). To use Google Pay, you must create a [development build](/develop/development-builds/create-a-build.md). This can be done with [EAS Build](/build/introduction.md), or locally by running `npx expo run:android`.

### Apple Pay

Apple Pay **is not** supported in [Expo Go](https://expo.dev/go). To use Apple Pay, you must create a [development build](/develop/development-builds/create-a-build.md). This can be done with [EAS Build](/build/introduction.md), or locally by running `npx expo run:ios`.
