...
source_url: "https://docs.expo.dev/versions/latest/sdk/sqlite.md"
scraped_at: "2026-07-15T08:44:39.853850"
---
...
Add the following configuration to your **metro.config.js**. If you don't have the **metro.config.js** yet, you can run `npx expo customize metro.config.js`. [Learn more](/guides/customizing-metro.md).
...
As with the [`useSQLiteContext()`](/versions/latest/sdk/sqlite.md#usesqlitecontext-hook) hook, you can also integrate the [`SQLiteProvider`](/versions/latest/sdk/sqlite.md#sqliteprovider) with [`React.Suspense`](https://react.dev/reference/react/Suspense) to show a fallback component until the database is ready. To enable the integration, pass the `useSuspense` prop to the `SQLiteProvider` component.
...
To open a new SQLite database using an existing **.db** file you already have, you can use the [`SQLiteProvider`](/versions/latest/sdk/sqlite.md#sqliteprovider) with [`assetSource`](/versions/latest/sdk/sqlite.md#assetsource).
...
Type: [MemoExoticComponent](#memoexoticcomponent)<(__namedParameters: [SQLiteProviderProps](#sqliteproviderprops)) => [Element](https://www.typescriptlang.org/docs/handbook/jsx.html#function-component)\>
...
Acceptable values are: `string` | `number` | `null` | `boolean` | [SQLiteBindBlobValue](#sqlitebindblobvalue)
